...
def makeunicodedata(unicode, trace):
    ...
    for item in table:
        print("    {category:%d, combining:%d, bidirectional:%d, mirrored:%d, east_asian_width:%d, normalization_quick_check:%d}," % item, file=fp)
    print("];", file=fp)
    print(file=fp)
    ...
    for start,end in comp_first_ranges:
        print("  { start:%d, count:%d, index:%d}," % (start,end-start,comp_first[start]), file=fp)
    print("];\n", file=fp)
    print("var nfc_last = [", file=fp)
    for start,end in comp_last_ranges:
        print("  { start:%d, count:%d, index:%d}," % (start,end-start,comp_last[start]), file=fp)
    print("];\n", file=fp)
...
def makeunicodetype(unicode, trace):
    ...
    for item in table:
        print("    {upper:%d, lower:%d, title:%d, decimal:%d, digit:%d, flags:%d}," % item, file=fp)
    print("];", file=fp)
    print(file=fp)
